...
up : ```../migrate -path db/migrations -database "postgres://postgres:postohN6Nei0ugiRena5gres@project-sprint-postgres.cavsdeuj9ixh.ap-southeast-1.rds.amazonaws.com:5432?sslmode=verify-full&sslrootcert=ap-southeast-1-bundle.pem" up```
